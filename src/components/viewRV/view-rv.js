    ...
    return (
        <div>
            ...
            <div className="col-md-8">
                ...
                <i className="fa fa-fw fa-globe" aria-hidden="true" title="Pública"></i>
                <i className="fa fa-fw fa-lock" aria-hidden="true" title="Privada"></i>
                <p className="m-0">Por: @Nombredeusuario hace <span class="date"> · 10 min</span></p>
                <p>Uno nunca sabe los peligros que te vas a encontrar cuando llegas a lo profundo del nucleo de este hermoso pero peligroso planeta al que llamamos tierra. Me gustarian unas pizzas al estilo Santiago.</p>
