...
import { Card, CardBody, Button, CardTitle, CardText, CardImg, CardSubtitle, ListGroup, ListGroupItem } from 'reactstrap';
...
export default class UserCard extends React.Component {
    ...
    render () {
        ...
        <div className="col-md-2 p-2">
            <Card className="user">
                <CardImg width="100%" src="https://lh4.googleusercontent.com/-WHb2PGFg70g/AAAAAAAAAAI/AAAAAAAAAAA/4KM01AzHqeo/photo.jpg" alt="Card image cap" />
                ...
                <div className="p-2"> 
                    <p>Esto es una descripcion generica, a mi me gusta jugar con mis amigos imaginarios lalala</p>
                </div>
                <ListGroup>
